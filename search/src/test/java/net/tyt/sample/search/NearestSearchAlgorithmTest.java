 ...
 * @author 69TytarIA
 */
public abstract class NearestSearchAlgorithmTest {

    private final NearestSearchAlgorithm algorithm = newAlgorithm();
    ...
    static Stream<int[]> arraysStream() {
        return Stream.of(
                ...
                new int[]{4, 8, 1, 9, 4, 7, 0, 2, 5}
        );
    } 

    abstract protected NearestSearchAlgorithm newAlgorithm();
